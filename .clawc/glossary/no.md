...
- PR #10018: https://github.com/anomalyco/clawc/pull/10018
- PR #12935: https://github.com/anomalyco/clawc/pull/12935

## Do Not Translate (Locale Additions)

- `OpenCode` (preserve casing in prose; keep `clawc` only in commands, package names, paths, or code)
- `OpenCode CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
