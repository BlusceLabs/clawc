...
- PR #15835: https://github.com/anomalyco/clawc/pull/15835

## Do Not Translate (Locale Additions)

- `OpenCode` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `clawc` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `OpenCode` in prose, `clawc` only for exact technical identifiers
...
- Avoid changing `clawc` to `OpenCode` inside commands, URLs, package names, or code literals
