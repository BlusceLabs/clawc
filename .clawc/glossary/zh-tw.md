...
- PR #13942: https://github.com/anomalyco/clawc/pull/13942

## Do Not Translate (Locale Additions)

- `OpenCode` (preserve casing in prose; keep `clawc` only when it is part of commands, package names, paths, or code)
- `OpenCode Zen`
- `OpenCode CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `clawc` in prose when referring to the product name; use `OpenCode`
