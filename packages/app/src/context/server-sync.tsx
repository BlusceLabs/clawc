import type { Config, ClawcClient, Path, Project, ProviderAuthResponse } from "@clawc/sdk/v2/client"
...
export const loadMcpQuery = (scope: ServerScope, directory: string, sdk: ClawcClient) =>
  queryOptions({
    queryKey: [scope, directory, "mcp"] as const,
    queryFn: () => sdk.mcp.status().then((r) => r.data ?? {}),
  })

export const loadLspQuery = (scope: ServerScope, directory: string, sdk: ClawcClient) =>
  queryOptions({
...
export function createServerSyncContextInner(serverSDK: ServerSDK) {
  ...
  const sdkCache = new Map<string, ClawcClient>()
