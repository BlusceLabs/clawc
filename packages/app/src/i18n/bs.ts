export const dict = {
  ...
  "dialog.provider.clawc.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.clawc.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.clawcGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje ClawC",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u ClawC-u.",
  ...
  "provider.connect.clawcZen.line1":
    "ClawC Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  "provider.connect.clawcZen.line2":
    "Sa jednim API ključem dobijaš pristup modelima kao što su Claude, GPT, Gemini, GLM i drugi.",
  "provider.connect.clawcZen.visit.prefix": "Posjeti ",
  "provider.connect.clawcZen.visit.link": "clawc.ai/zen",
  "provider.connect.clawcZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u ClawC-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u ClawC-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u clawc.json",
  ...
  "dialog.server.description": "Promijeni na koji se ClawC server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija ClawC-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku ClawC timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (clawc.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: ClawC još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "ClawC uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni ClawC server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u ClawC-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako ClawC izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li ClawC prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu ClawC-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se ClawC pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju ClawC-a.",
