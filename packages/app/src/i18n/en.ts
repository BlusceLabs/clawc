export const dict = {
  ...
  "dialog.provider.clawc.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.clawc.tagline": "Reliable optimized models",
  "dialog.provider.clawcGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by ClawC",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in ClawC.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.clawcZen.line1":
    "ClawC Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.clawcZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.clawcZen.visit.prefix": "Visit ",
  "provider.connect.clawcZen.visit.link": "clawc.ai/zen",
  "provider.connect.clawcZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in ClawC.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in ClawC.",
  ...
  "dialog.plugins.empty": "Plugins configured in clawc.json",
  ...
  "dialog.server.description": "Switch which ClawC server this app connects to.",
  ...
  "wsl.onboarding.step.clawc": "ClawC",
  ...
  "wsl.onboarding.checkingOpencode": "Checking ClawC...",
  "wsl.onboarding.checkingOpencodeIn": "Checking ClawC in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating ClawC...",
  "wsl.onboarding.updatingOpencodeIn": "Updating ClawC in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update ClawC in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update ClawC",
  "wsl.onboarding.ClawcReadyIn": "ClawC is ready in {{distro}}.",
  "wsl.onboarding.ClawcReady": "ClawC is ready.",
  "wsl.onboarding.installOpencodeIn": "Install ClawC in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install ClawC",
  ...
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen ClawC.",
  ...
  "toast.update.description": "A new version of ClawC ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the ClawC team",
  ...
  "error.chain.checkConfig": "Check your config (clawc.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, ClawC does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "ClawC includes free models so you can start immediately.",
  ...
  "app.name.desktop": "ClawC Desktop",
  ...
  "settings.desktop.wsl.description": "Run the ClawC server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for ClawC",
  ...
  "settings.general.row.appearance.description": "Customise how ClawC looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether ClawC follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how ClawC is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when ClawC launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of ClawC.",
