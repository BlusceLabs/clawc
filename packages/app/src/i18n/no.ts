...
export const dict = {
  ...
  "dialog.provider.clawc.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.clawc.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.clawcGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av ClawC",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i ClawC.",
  ...
  "provider.connect.clawcZen.line1":
    "ClawC Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.clawcZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.clawcZen.visit.prefix": "Besøk ",
  "provider.connect.clawcZen.visit.link": "clawc.ai/zen",
  "provider.connect.clawcZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i ClawC.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i ClawC.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i clawc.json",
  ...
  "dialog.server.description": "Bytt hvilken ClawC-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av ClawC ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til ClawC-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (clawc.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at ClawC ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "ClawC inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør ClawC-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for ClawC",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan ClawC ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om ClawC skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan ClawC er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når ClawC starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av ClawC.",
