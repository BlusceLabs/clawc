export const dict = {
  ...
  "dialog.provider.clawc.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.clawc.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.clawcGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez ClawC",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w ClawC.",
  ...
  "provider.connect.clawcZen.line1":
    "ClawC Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  "provider.connect.clawcZen.line2":
    "Z jednym kluczem API uzyskasz dostęp do modeli takich jak Claude, GPT, Gemini, GLM i więcej.",
  "provider.connect.clawcZen.visit.prefix": "Odwiedź ",
  "provider.connect.clawcZen.visit.link": "clawc.ai/zen",
  "provider.connect.clawcZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w ClawC.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w ClawC.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w clawc.json",
  ...
  "dialog.server.description": "Przełącz serwer ClawC, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja ClawC ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu ClawC",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (clawc.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "ClawC zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla ClawC",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd ClawC na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy ClawC ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw ClawC.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania ClawC",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji ClawC.",
