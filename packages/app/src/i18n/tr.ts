...
export const dict = {
  ...
  "dialog.provider.clawc.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.clawc.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.clawcGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "ClawC tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve ClawC'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.clawcZen.line1":
    "ClawC Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.clawcZen.visit.prefix": "",
  "provider.connect.clawcZen.visit.link": "clawc.ai/zen",
  "provider.connect.clawcZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve ClawC'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak ClawC'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler clawc.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi ClawC sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "ClawC'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı ClawC ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (clawc.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: ClawC henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "ClawC ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "ClawC Masaüstü",
  ...
  "settings.desktop.wsl.description": "ClawC sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "ClawC'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "ClawC'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "ClawC'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "ClawC'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "ClawC başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "ClawC'un en son sürümünü kullanıyorsunuz.",
