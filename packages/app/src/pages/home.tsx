...
import { Logo } from "@clawc/ui/logo"
import { Spinner } from "@clawc/ui/spinner"
import { ScrollView } from "@clawc/ui/scroll-view"
import { ProjectAvatar } from "@clawc/ui/v2/project-avatar-v2"
import { ButtonV2 } from "@clawc/ui/v2/button-v2"
import { Icon as IconV2 } from "@clawc/ui/v2/icon"
import { IconButtonV2 } from "@clawc/ui/v2/icon-button-v2"
import { MenuV2 } from "@clawc/ui/v2/menu-v2"
import { TooltipV2 } from "@clawc/ui/v2/tooltip-v2"
...
import { preloadMarkdown } from "@clawc/session-ui/markdown-cache"
    ...
    <div class="rounded-[10px] shadow-[var(--v2-elevation-raised)] m-2 min-h-0 lg:overflow-hidden bg-v2-background-bg-base self-stretch flex-1">
      <div class="mx-auto grid h-full w-full max-w-[1080px] grid-rows-[auto_minmax(0,1fr)_auto] gap-4 px-3 pb-3 lg:grid-cols-[280px_minmax(0,720px)] lg:grid-rows-1 lg:gap-8 lg:px-6 lg:pb-16">
        <HomeProjectColumn
          ...
          openHelp={() => platform.openLink("https://clawc.ai/desktop-feedback")}
          language={language}
        />
