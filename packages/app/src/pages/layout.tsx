...
import { Session } from "@clawc/sdk/v2/client"
...
import { toaster } from "@clawc/ui/toast"
...
import { useTheme, type ColorScheme } from "@clawc/ui/theme/context"
...
export default function LegacyLayout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://clawc.ai/desktop-feedback")}
      renderPanel={() =>
