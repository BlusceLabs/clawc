...
Practical reference for the current tool-migration state in `packages/clawc`.
...
Tool tests should use the existing Effect helpers in `packages/clawc/test/lib/effect.ts`:
