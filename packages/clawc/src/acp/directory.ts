...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@clawc/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@clawc/ACPDirectory") {}
