...
import type { AssistantMessage as OpenCodeAssistantMessage, Message } from "@clawc/sdk/v2"
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@clawc/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@clawc/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@clawc/ACPUsage") {}
