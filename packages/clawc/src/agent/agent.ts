...
import { AbsolutePath, type DeepMutable } from "@clawc/core/schema"
...
import { Reference } from "@clawc/core/reference"
...
export class Service extends Context.Service<Service, Interface>()("@clawc/Agent") {}
          ...
          plan: {
            ...
            permission: Permission.merge(
              ...
              Permission.fromConfig({
                ...
                edit: {
                  "*": "deny",
                  [path.join(".clawc", "plans", "*.md")]: "allow",
