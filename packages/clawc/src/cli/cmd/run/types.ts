// Shared type vocabulary for the direct interactive mode (`clawc --mini`).
//
...
import type { OpencodeClient, PermissionRequest, QuestionRequest, ToolPart } from "@clawc/sdk/v2"
