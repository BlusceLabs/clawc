...
//
// The saved variant persists across sessions in ~/.local/state/clawc/model.json
...
class Service extends Context.Service<Service, VariantService>()("@clawc/RunVariant") {}
