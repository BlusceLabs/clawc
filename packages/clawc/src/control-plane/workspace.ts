...
import { EventSequenceTable, EventTable } from "@clawc/core/event/sql"
import { FSUtil } from "@clawc/core/fs-util"
import { RuntimeFlags } from "@/effect/runtime-flags"
import { ProjectV2 } from "@clawc/core/project"
import { Slug } from "@clawc/core/util/slug"
...
import { WorkspaceEvent } from "@clawc/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@clawc/Workspace") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        CLAWC_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        CLAWC_WORKSPACE_ID: config.id,
        CLAWC_EXPERIMENTAL_WORKSPACES: "true",
