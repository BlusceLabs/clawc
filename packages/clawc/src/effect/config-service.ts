 ...
 *   "@clawc/ServerAuthConfig",
 *   {
 *     password: Config.string("CLAWC_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("CLAWC_SERVER_USERNAME").pipe(Config.withDefault("clawc")),
 *   },
 * ) {}
 *
