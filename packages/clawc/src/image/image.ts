...
export class Service extends Context.Service<Service, Interface>()("@clawc/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __CLAWC_PHOTON_WASM_PATH?: string }).__CLAWC_PHOTON_WASM_PATH =
