...
import { gitlabAuthPlugin as GitlabAuthPlugin } from "clawc-gitlab-auth"
import { PoeAuthPlugin } from "clawc-poe-auth"
...
export class Service extends Context.Service<Service, Interface>()("@clawc/Plugin") {}
