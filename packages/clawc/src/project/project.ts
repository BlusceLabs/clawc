...
import { ProjectDirectoryTable, ProjectTable } from "@clawc/core/project/sql"
...
import { which } from "@clawc/core/util/which"
...
export class Service extends Context.Service<Service, Interface>()("@clawc/Project") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.CLAWC_FAKE_VCS)
