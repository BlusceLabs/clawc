...
import { makeApi } from "@clawc/protocol/api"
import { LocationMiddleware } from "@clawc/server/location"
import { SessionLocationMiddleware } from "@clawc/server/middleware/session-location"
...
export const RootHttpApi = HttpApi.make("clawc-root")
...
export const InstanceHttpApi = HttpApi.make("clawc-instance")
