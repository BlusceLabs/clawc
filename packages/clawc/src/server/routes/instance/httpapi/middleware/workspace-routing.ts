...
>()("@clawc/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@clawc/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.CLAWC_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.CLAWC_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-clawc-directory"] || process.cwd()
}
