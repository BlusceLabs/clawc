...
import { buildPrompt } from "@clawc/core/session/compaction"
import { SessionCompactionEvent } from "@clawc/schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@clawc/SessionCompaction") {}
