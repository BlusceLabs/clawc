import type { JsonSchema, LLMRequest, ProviderMetadata } from "@clawc/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@clawc/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @clawc/llm request objects from clawc's session/AI SDK-shaped data.
  return LLM.request({
