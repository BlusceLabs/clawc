...
import { MAX_STEPS_PROMPT } from "@clawc/core/session/runner/max-steps"
...
import { LLM } from "./llm"
import { Shell } from "@clawc/core/shell"
...
import { SessionEvent } from "@clawc/core/session/event"
...
import { AgentAttachment, FileAttachment, Prompt, Source } from "@clawc/core/session/prompt"
import * as DateTime from "effect/DateTime"
import { eq } from "drizzle-orm"
import { SessionTable } from "@clawc/core/session/sql"
import { SessionReminders } from "./reminders"
import { SessionTools } from "./tools"
import { LLMEvent } from "@clawc/llm"
...
export class Service extends Context.Service<Service, Interface>()("@clawc/SessionPrompt") {}
                ...
                if (range.start != null) {
                  ...
                  if (start === end) {
                    ...
                    for (const symbol of symbols) {
                      ...
                      if (r?.start?.line != null && r?.start?.line === start) {
                        start = r.start.line
