...
import type { ProviderMetadata, Usage } from "@clawc/llm"
...
import { SessionExecution } from "@clawc/core/session/execution"
...
import { PartTable, SessionTable } from "@clawc/core/session/sql"
...
import { NonNegativeInt, optional } from "@clawc/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".clawc", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@clawc/Session") {}
