...
import type * as SDK from "@clawc/sdk/v2"
...
import { SessionShareTable } from "@clawc/core/share/sql"
import { ProviderV2 } from "@clawc/core/provider"
import { ModelV2 } from "@clawc/core/model"
import { EventV2 } from "@clawc/core/event"

const disabled = process.env["CLAWC_DISABLE_SHARE"] === "true" || process.env["CLAWC_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@clawc/ShareNext") {}
