...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@clawc/plugin"
...
export function webSearchEnabled(providerID: ProviderV2.ID, flags = { exa: false, parallel: false }) {
  return providerID === ProviderV2.ID.clawc || flags.exa || flags.parallel
}
...
export class Service extends Context.Service<Service, Interface>()("@clawc/ToolRegistry") {}
