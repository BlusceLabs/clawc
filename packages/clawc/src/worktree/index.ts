...
import { path } from "@clawc/core/effect/layer-node-platform"
...
import type { ProjectV2 } from "@clawc/core/project"
...
import { WorktreeEvent } from "@clawc/schema/worktree-event"
...
export class Service extends Context.Service<Service, Interface>()("@clawc/Worktree") {}
  ...
  Effect.gen(function* () {
    ...
    const candidate = Effect.fn("Worktree.candidate")(function* (input: {
      ...
      for (const attempt of Array.from({ length: MAX_NAME_ATTEMPTS }, (_, i) => i)) {
        ...
        const branch = input.detached ? undefined : `clawc/${name}`
