...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/clawc.git")).toEqual({ owner: "sst", repo: "clawc" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/clawc")).toEqual({ owner: "sst", repo: "clawc" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/clawc.git")).toEqual({ owner: "sst", repo: "clawc" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/clawc")).toEqual({ owner: "sst", repo: "clawc" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/clawc.git")).toEqual({ owner: "sst", repo: "clawc" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/clawc")).toEqual({ owner: "sst", repo: "clawc" })
})
