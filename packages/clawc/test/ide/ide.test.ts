...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders CLAWC_CALLER", () => {
    process.env["CLAWC_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode CLAWC_CALLER", () => {
    process.env["CLAWC_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown CLAWC_CALLER", () => {
    process.env["CLAWC_CALLER"] = "unknown"
