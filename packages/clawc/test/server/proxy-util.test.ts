...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips clawc-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-clawc-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-clawc-directory")).toBeNull()
      expect(result.get("x-clawc-workspace")).toBeNull()
