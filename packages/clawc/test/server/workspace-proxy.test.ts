...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips clawc-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-clawc-directory"]).toBeUndefined()
      expect(forwarded["x-clawc-workspace"]).toBeUndefined()
