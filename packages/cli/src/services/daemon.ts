...
import { createOpencodeClient } from "@clawc/sdk/v2/client"
import { ServerAuth } from "@clawc/server/auth"
...
export class Service extends Context.Service<Service, Interface>()("@clawc/cli/Daemon") {}
