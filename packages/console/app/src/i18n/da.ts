...
export const dict = {
  ...
  "notFound.title": "Ikke fundet | clawc",
  ...
  "app.meta.description": "ClawC - Den open source kodningsagent.",

  "home.title": "ClawC | Den open source AI-kodningsagent",

  "temp.title": "clawc | AI-kodningsagent bygget til terminalen",
  ...
  "temp.feature.zen.afterLink": "leveret af clawc",
  ...
  "temp.screenshot.caption": "clawc TUI med tokyonight-temaet",
  "temp.screenshot.alt": "clawc TUI med tokyonight-temaet",
  ...
  "home.what.title": "Hvad er ClawC?",
  "home.what.body":
    "ClawC er en open source agent, der hjælper dig med at skrive kode i din terminal, IDE eller desktop.",
  ...
  "home.growth.body":
    "Med over <strong>{{stars}}</strong> GitHub-stjerner, <strong>{{contributors}}</strong> bidragsydere og over <strong>{{commits}}</strong> commits bruges ClawC af over <strong>{{monthlyUsers}}</strong> udviklere hver måned.",
  ...
  "home.privacy.body":
    "ClawC gemmer ikke din kode eller kontekstdata, så den kan bruges i privatlivsfølsomme miljøer.",
  "home.privacy.learnMore": "Læs mere om",
  "home.privacy.link": "privatliv",

  "home.faq.q1": "Hvad er ClawC?",
  "home.faq.a1":
    "ClawC er en open source agent, der hjælper dig med at skrive og køre kode med enhver AI-model. Den er tilgængelig som terminal-interface, desktop-app eller IDE-udvidelse.",
  "home.faq.q2": "Hvordan bruger jeg ClawC?",
  "home.faq.a2.before": "Den nemmeste måde at komme i gang på er at læse",
  "home.faq.a2.link": "introen",
  "home.faq.q3": "Skal jeg have ekstra AI-abonnementer for at bruge ClawC?",
  "home.faq.a3.p1":
    "Ikke nødvendigvis. ClawC kommer med gratis modeller, som du kan bruge uden at oprette en konto.",
  "home.faq.a3.p2.beforeZen": "Derudover kan du bruge populære kodningsmodeller ved at oprette en",
  "home.faq.a3.p2.afterZen": " konto.",
  "home.faq.a3.p3":
    "Vi opfordrer til at bruge Zen, men ClawC virker også med populære udbydere som OpenAI, Anthropic, xAI osv.",
  "home.faq.a3.p4.beforeLocal": "Du kan endda forbinde dine",
  "home.faq.a3.p4.localLink": "lokale modeller",
  "home.faq.q4": "Kan jeg bruge mine eksisterende AI-abonnementer med ClawC?",
  "home.faq.a4.p1":
    "Ja. ClawC understøtter abonnementer fra alle store udbydere. Du kan bruge Claude Pro/Max, ChatGPT Plus/Pro eller GitHub Copilot.",
  "home.faq.q5": "Kan jeg kun bruge ClawC i terminalen?",
  "home.faq.a5.beforeDesktop": "Ikke længere! ClawC er nu tilgængelig som en app til",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "og",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Hvad koster ClawC?",
  "home.faq.a6":
    "ClawC er 100% gratis at bruge. Det kommer også med et sæt gratis modeller. Der kan være ekstra omkostninger, hvis du forbinder en anden udbyder.",
  ...
  "home.faq.q8": "Er ClawC open source?",
  "home.faq.a8.p1": "Ja, ClawC er fuldt open source. Kildekoden er offentlig på",
  ...
  "home.zenCta.body":
    "Zen giver dig adgang til et håndplukket sæt AI-modeller, som ClawC har testet og benchmarked specifikt til kodningsagenter. Du behøver ikke bekymre dig om svingende performance og kvalitet på tværs af udbydere: brug validerede modeller, der virker.",
  "home.zenCta.link": "Læs om Zen",

  "zen.title": "ClawC Zen | Et kurateret sæt af pålidelige, optimerede modeller til kodningsagenter",
  "zen.hero.title": "Pålidelige optimerede modeller til kodningsagenter",
  "zen.hero.body":
    "Zen giver dig adgang til et kurateret sæt AI-modeller, som ClawC har testet og benchmarked specifikt til kodningsagenter. Du behøver ikke bekymre dig om svingende performance og kvalitet: brug validerede modeller, der virker.",

  "zen.faq.q1": "Hvad er ClawC Zen?",
  "zen.faq.a1":
    "Zen er et kurateret sæt AI-modeller testet og benchmarked til kodningsagenter, skabt af teamet bag ClawC.",
  ...
  "zen.faq.a3":
    "Zen er ikke for profit. Zen videregiver omkostningerne fra modeludbyderne til dig. Jo mere Zen bruges, desto mere kan ClawC forhandle bedre priser og give dem videre til dig.",
  ...
  "zen.faq.a4.p3":
    "For at dække omkostninger tilføjer ClawC kun et lille betalingsgebyr på $1.23 per $20 saldo-opfyldning.",
  ...
  "zen.faq.a8":
    "Selvom Zen fungerer godt med ClawC, kan du bruge Zen med enhver agent. Følg opsætningsinstruktionerne i din foretrukne kodningsagent.",
  ...
  "zen.problem.subtitle": "Vi løser dette for alle, ikke kun ClawC-brugere.",
  ...
  "zen.how.body": "Selvom vi foreslår, at du bruger Zen med ClawC, kan du bruge Zen med enhver agent.",
  ...
  "go.title": "ClawC Go | Kodningsmodeller til lav pris for alle",
  ...
  "go.problem.body":
    "Vi fokuserer på at bringe ClawC-oplevelsen ud til så mange som muligt. ClawC Go er et lavprisabonnement: $5 for den første måned, derefter $10/måned. Det giver generøse grænser og pålidelig adgang til de mest kapable open source-modeller.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body":
    "Go starter ved $5 for den første måned, derefter $10/måned. Du kan bruge det med ClawC eller enhver agent.",
  ...
  "zen.api.error.trialEnded":
    "Den gratis kampagne for {{model}} er afsluttet. Du kan fortsætte med at bruge modellen ved at abonnere på ClawC Go - {{link}}",

  "black.meta.title": "ClawC Black | Få adgang til verdens bedste kodningsmodeller",
  "black.meta.description": "Få adgang til Claude, GPT, Gemini og mere med ClawC Black-abonnementer.",
  ...
  "black.workspace.title": "ClawC Black | Vælg workspace",
  ...
  "black.subscribe.success.title": "Du er på ClawC Black-ventelisten",
  ...
  "workspace.newUser.feature.lockin.body":
    "Brug Zen med en hvilken som helst kodningsagent, og fortsæt med at bruge andre udbydere med clawc, når du vil.",
  ...
  "workspace.newUser.step.login.after": "og vælg clawc",
  "workspace.newUser.step.pasteKey": "Indsæt din API-nøgle",
  "workspace.newUser.step.models.before": "Start clawc og kør",
  ...
  "workspace.keys.subtitle": "Administrer dine API-nøgler for at få adgang til clawc-tjenester.",
  "workspace.keys.create": "Opret API-nøgle",
  "workspace.keys.placeholder": "Indtast nøglenavn",
  "workspace.keys.empty": "Opret en clawc Gateway API-nøgle",
  ...
  "workspace.black.subscription.message": "Du abonnerer på ClawC Black for ${{plan}} om måneden.",
  ...
  "workspace.black.waitlist.joined": "Du er på ventelisten for ${{plan}} per måned ClawC Black plan.",
  "workspace.black.waitlist.ready": "Vi er klar til at tilmelde dig ${{plan}} per måned ClawC Black plan.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Vælg "ClawC Go" som udbyder i din clawc-konfiguration for at bruge Go-modeller.',
  "workspace.lite.black.message":
    "Du abonnerer i øjeblikket på ClawC Black eller er på venteliste. Afmeld venligst først, hvis du vil skifte til Go.",
  "workspace.lite.other.message":
    "Et andet medlem i dette workspace abonnerer allerede på ClawC Go. Kun ét medlem pr. workspace kan abonnere.",
  "workspace.lite.promo.description":
    "ClawC Go starter ved {{price}}, derefter $10/måned, og giver pålidelig adgang til populære åbne kodningsmodeller med generøse brugsgrænser.",
  ...
  "download.meta.description": "Download ClawC til macOS, Windows og Linux",
  "download.hero.title": "Download ClawC",
  ...
  "download.faq.a3.beforeLocal":
    "Ikke nødvendigvis, men sandsynligvis. Du skal bruge et AI-abonnement hvis du vil forbinde ClawC til en betalt udbyder, men du kan arbejde med",
  ...
  "download.faq.a3.afterZen": ", fungerer ClawC med alle populære udbydere som OpenAI, Anthropic, xAI osv.",

  "download.faq.a5.p1": "ClawC er 100% gratis at bruge.",
  "download.faq.a5.p2.beforeZen":
    "Eventuelle ekstra omkostninger kommer fra dit abonnement hos en modeludbyder. Selvom ClawC fungerer med enhver modeludbyder, anbefaler vi at bruge",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Dine data og oplysninger gemmes kun når du opretter delbare links i ClawC.",
  "download.faq.a6.p2.beforeShare": "Læs mere om",
  "download.faq.a6.shareLink": "delingssider",

  "enterprise.title": "ClawC | Enterprise-løsninger til din organisation",
  "enterprise.meta.description": "Kontakt ClawC for enterprise-løsninger",
  "enterprise.hero.title": "Din kode er din egen",
  "enterprise.hero.body1":
    "ClawC fungerer sikkert inde i din organisation uden at lagre data eller kontekst og uden licensbegrænsninger eller ejerskabskrav. Start en prøveperiode med dit team, og udrul det derefter i hele din organisation ved at integrere det med dit SSO og din interne AI-gateway.",
  ...
  "enterprise.faq.q1": "Hvad er ClawC Enterprise?",
  "enterprise.faq.a1":
    "ClawC Enterprise er til organisationer, der vil sikre, at deres kode og data aldrig forlader deres infrastruktur. Det kan gøres med en central konfiguration, der integrerer med dit SSO og din interne AI-gateway.",
  "enterprise.faq.q2": "Hvordan kommer jeg i gang med ClawC Enterprise?",
  "enterprise.faq.a2":
    "Start blot med en intern prøveperiode med dit team. ClawC gemmer som standard ikke din kode eller kontekstdata, hvilket gør det nemt at komme i gang. Kontakt os derefter for at tale om priser og implementeringsmuligheder.",
  ...
  "enterprise.faq.q4": "Er mine data sikre med ClawC Enterprise?",
  "enterprise.faq.a4":
    "Ja. ClawC gemmer ikke din kode eller kontekstdata. Al behandling sker lokalt eller via direkte API-kald til din AI-udbyder. Med central konfiguration og SSO-integration forbliver dine data sikre inden for din organisations infrastruktur.",

  "brand.title": "ClawC | Brand",
  "brand.meta.description": "ClawC brandretningslinjer",
  "brand.heading": "Brandretningslinjer",
  "brand.subtitle": "Ressourcer og assets, der hjælper dig med at arbejde med ClawC-brandet.",
  "brand.downloadAll": "Download alle assets",

  "changelog.title": "ClawC | Changelog",
  "changelog.meta.description": "ClawC versionsnoter og changelog",
  "changelog.hero.title": "Changelog",
  "changelog.hero.subtitle": "Nye opdateringer og forbedringer til ClawC",
