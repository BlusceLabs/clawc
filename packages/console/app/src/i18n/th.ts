...
export const dict = {
  ...
  "notFound.title": "ไม่พบหน้า | ClawC",
  "notFound.heading": "404 - ไม่พบหน้าที่ค้นหา",
  "notFound.home": "หน้าหลัก",
  "notFound.docs": "เอกสาร",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "โลโก้ clawc แบบสว่าง",
  "notFound.logoDarkAlt": "โลโก้ clawc แบบมืด",
  ...
  "app.meta.description": "ClawC - เอเจนต์เขียนโค้ดแบบโอเพนซอร์ส",

  "home.title": "ClawC | เอเจนต์เขียนโค้ดด้วย AI แบบโอเพนซอร์ส",

  "temp.title": "ClawC | เอเจนต์เขียนโค้ด AI ที่สร้างมาเพื่อเทอร์มินัล",
  ...
  "temp.feature.zen.afterLink": "โดย ClawC",
  "temp.feature.models.beforeLink": "รองรับผู้ให้บริการ LLM กว่า 75 รายผ่าน",
  "temp.feature.models.afterLink": "รวมถึงโมเดล Local",
  "temp.screenshot.caption": "ClawC TUI พร้อมธีม tokyonight",
  "temp.screenshot.alt": "ClawC TUI พร้อมธีม tokyonight",
  "temp.logoLightAlt": "โลโก้ clawc แบบสว่าง",
  "temp.logoDarkAlt": "โลโก้ clawc แบบมืด",
  ...
  "home.what.title": "ClawC คืออะไร?",
  "home.what.body": "ClawC คือเอเจนต์โอเพนซอร์สที่ช่วยคุณเขียนโค้ดในเทอร์มินัล, IDE หรือเดสก์ท็อป",
  ...
  "home.growth.body":
    "ด้วยยอดดาวบน GitHub กว่า <strong>{{stars}}</strong> ดวง, ผู้ร่วมพัฒนา <strong>{{contributors}}</strong> คน, และการคอมมิตกว่า <strong>{{commits}}</strong> ครั้ง, ClawC ได้รับความไว้วางใจจากนักพัฒนากว่า <strong>{{monthlyUsers}}</strong> คนในทุกเดือน",
  ...
  "home.privacy.body":
    "ClawC ไม่จัดเก็บโค้ดหรือข้อมูลบริบทของคุณ เพื่อให้สามารถทำงานในสภาพแวดล้อมที่ให้ความสำคัญกับความเป็นส่วนตัวได้",
  "home.privacy.learnMore": "เรียนรู้เพิ่มเติมเกี่ยวกับ",
  "home.privacy.link": "ความเป็นส่วนตัว",

  "home.faq.q1": "ClawC คืออะไร?",
  "home.faq.a1":
    "ClawC เป็นเอเจนต์โอเพนซอร์สที่ช่วยให้คุณเขียนและรันโค้ดด้วยโมเดล AI ใดก็ได้ มีให้เลือกใช้ทั้งแบบอินเทอร์เฟซเทอร์มินัล, แอปเดสก์ท็อป หรือส่วนขยาย IDE",
  "home.faq.q2": "ฉันจะเริ่มใช้ ClawC ได้อย่างไร?",
  "home.faq.a2.before": "วิธีเริ่มต้นที่ง่ายที่สุดคืออ่าน",
  "home.faq.a2.link": "บทนำ",
  "home.faq.q3": "ต้องสมัครสมาชิก AI เพิ่มเติมเพื่อใช้ ClawC หรือไม่?",
  "home.faq.a3.p1": "ไม่จำเป็นเสมอไป ClawC มาพร้อมกับชุดโมเดลฟรีที่คุณสามารถใช้ได้โดยไม่ต้องสร้างบัญชี",
  "home.faq.a3.p2.beforeZen": "นอกจากนี้ คุณสามารถใช้โมเดลยอดนิยมใดก็ได้โดยการสร้างบัญชี",
  "home.faq.a3.p2.afterZen": "",
  "home.faq.a3.p3":
    "แม้เราจะแนะนำให้ใช้ Zen แต่ ClawC ก็ทำงานร่วมกับผู้ให้บริการยอดนิยมทั้งหมด เช่น OpenAI, Anthropic, xAI เป็นต้น",
  "home.faq.a3.p4.beforeLocal": "คุณยังสามารถเชื่อมต่อกับ",
  "home.faq.a3.p4.localLink": "โมเดล Local ของคุณ",
  "home.faq.q4": "ฉันสามารถใช้การสมัครสมาชิก AI ที่มีอยู่กับ ClawC ได้หรือไม่?",
  "home.faq.a4.p1":
    "ได้ ClawC รองรับแผนการสมัครสมาชิกจากผู้ให้บริการหลักทั้งหมด คุณสามารถใช้การสมัครสมาชิก Claude Pro/Max, ChatGPT Plus/Pro หรือ GitHub Copilot ของคุณได้",
  "home.faq.q5": "ฉันใช้ ClawC ได้เฉพาะในเทอร์มินัลใช่หรือไม่?",
  "home.faq.a5.beforeDesktop": "ไม่อีกต่อไป! ClawC มีแอปสำหรับ",
  "home.faq.a5.desktop": "เดสก์ท็อป",
  "home.faq.a5.and": "และ",
  "home.faq.a5.web": "เว็บ",
  "home.faq.q6": "ClawC ราคาเท่าไหร่?",
  "home.faq.a6":
    "ClawC ใช้งานได้ฟรี 100% และมาพร้อมกับชุดโมเดลฟรี อาจมีค่าใช้จ่ายเพิ่มเติมหากคุณเชื่อมต่อกับผู้ให้บริการรายอื่น",
  ...
  "home.faq.q8": "ClawC เป็นโอเพนซอร์สหรือไม่?",
  "home.faq.a8.p1": "ใช่ ClawC เป็นโอเพนซอร์สเต็มรูปแบบ ซอร์สโค้ดเปิดเผยต่อสาธารณะบน",
  ...
  "home.zenCta.body":
    "Zen ให้คุณเข้าถึงชุดโมเดล AI ที่คัดสรรมาแล้ว ซึ่ง ClawC ได้ทดสอบและทำเบนช์มาร์กโดยเฉพาะสำหรับเอเจนต์เขียนโค้ด ไม่ต้องกังวลเรื่องประสิทธิภาพและคุณภาพที่ไม่สม่ำเสมอจากผู้ให้บริการ ใช้โมเดลที่ผ่านการตรวจสอบแล้วว่าใช้งานได้จริง",
  "home.zenCta.link": "เรียนรู้เกี่ยวกับ Zen",

  "zen.title": "ClawC Zen | ชุดโมเดลที่คัดสรรมาอย่างดี เชื่อถือได้ และปรับแต่งแล้วสำหรับเอเจนต์เขียนโค้ด",
  "zen.hero.title": "โมเดลที่ปรับแต่งมาอย่างดีและเชื่อถือได้สำหรับเอเจนต์เขียนโค้ด",
  "zen.hero.body":
    "Zen ให้คุณเข้าถึงชุดโมเดล AI ที่คัดสรรมาแล้ว ซึ่ง ClawC ได้ทดสอบและทำเบนช์มาร์กโดยเฉพาะสำหรับเอเจนต์เขียนโค้ด ไม่ต้องกังวลเรื่องประสิทธิภาพและคุณภาพที่ไม่สม่ำเสมอ ใช้โมเดลที่ผ่านการตรวจสอบแล้วว่าใช้งานได้จริง",

  "zen.faq.q1": "ClawC Zen คืออะไร?",
  "zen.faq.a1":
    "Zen คือชุดโมเดล AI ที่คัดสรรมาอย่างดี ผ่านการทดสอบและทำเบนช์มาร์กสำหรับเอเจนต์เขียนโค้ด สร้างโดยทีมงานผู้อยู่เบื้องหลัง ClawC",
  ...
  "zen.faq.a3":
    "Zen ไม่ได้แสวงหากำไร Zen ส่งผ่านต้นทุนจากผู้ให้บริการโมเดลมาถึงคุณ ยิ่งมีการใช้งาน Zen มากเท่าไหร่ ClawC ก็ยิ่งสามารถต่อรองเรตราคาที่ดีกว่าและส่งต่อให้คุณได้มากขึ้นเท่านั้น",
  ...
  "zen.faq.a4.p3":
    "เพื่อครอบคลุมต้นทุน ClawC คิดค่าธรรมเนียมการประมวลผลการชำระเงินเพียงเล็กน้อย $1.23 ต่อการเติมเงิน $20",
  ...
  "zen.faq.a8":
    "แม้ว่า Zen จะทำงานได้ดีเยี่ยมกับ ClawC แต่คุณสามารถใช้ Zen กับเอเจนต์ใดก็ได้ เพียงทำตามคำแนะนำการตั้งค่าในเอเจนต์เขียนโค้ดที่คุณต้องการ",
  ...
  "zen.problem.subtitle": "เรากำลังแก้ไขปัญหานี้สำหรับทุกคน ไม่ใช่แค่ผู้ใช้ ClawC เท่านั้น",
  ...
  "zen.how.body": "แม้เราจะแนะนำให้คุณใช้ Zen กับ ClawC แต่คุณสามารถใช้ Zen กับเอเจนต์ใดก็ได้",
  ...
  "go.title": "ClawC Go | โมเดลเขียนโค้ดราคาประหยัดสำหรับทุกคน",
  ...
  "go.problem.body":
    "เรามุ่งมั่นที่จะนำประสบการณ์ ClawC ไปสู่ผู้คนให้ได้มากที่สุด ClawC Go เป็นการสมัครสมาชิกราคาประหยัด: $5 สำหรับเดือนแรก จากนั้น $10/เดือน โดยมอบขีดจำกัดที่เอื้อเฟื้อและการเข้าถึงโมเดลโอเพนซอร์สที่มีความสามารถสูงสุดอย่างเชื่อถือได้",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go เริ่มต้นที่ $5 สำหรับเดือนแรก จากนั้น $10/เดือน คุณสามารถใช้กับ ClawC หรือเอเจนต์ใดก็ได้",
  ...
  "zen.api.error.trialEnded":
    "โปรโมชันฟรีสำหรับ {{model}} สิ้นสุดแล้ว คุณสามารถใช้โมเดลต่อได้โดยสมัครสมาชิก ClawC Go - {{link}}",

  "black.meta.title": "ClawC Black | เข้าถึงโมเดลเขียนโค้ดที่ดีที่สุดในโลก",
  "black.meta.description": "เข้าถึง Claude, GPT, Gemini และอื่นๆ ด้วยแผนสมาชิก ClawC Black",
  "black.hero.title": "เข้าถึงโมเดลเขียนโค้ดที่ดีที่สุดในโลก",
  "black.hero.subtitle": "รวมถึง Claude, GPT, Gemini และอื่นๆ อีกมากมาย",
  "black.title": "ClawC Black | ราคา",
  ...
  "black.workspace.title": "ClawC Black | เลือก Workspace",
  "black.workspace.selectPlan": "เลือก Workspace สำหรับแผนนี้",
  "black.workspace.name": "Workspace {{n}}",
  "black.subscribe.title": "สมัครสมาชิก ClawC Black",
  ...
  "black.subscribe.success.title": "คุณอยู่ในรายชื่อรอ ClawC Black แล้ว",
  ...
  "workspace.newUser.feature.lockin.body":
    "ใช้ Zen กับเอเจนต์เขียนโค้ดใดก็ได้ และกลับมาใช้ผู้ให้บริการรายอื่นด้วย ClawC ได้ทุกเมื่อที่คุณต้องการ",
  ...
  "workspace.newUser.step.login.after": "และเลือก ClawC",
  "workspace.newUser.step.pasteKey": "วาง API key ของคุณ",
  "workspace.newUser.step.models.before": "เริ่ม ClawC และรัน",
  ...
  "workspace.keys.subtitle": "จัดการ API keys ของคุณสำหรับการเข้าถึงบริการ ClawC",
  "workspace.keys.create": "สร้าง API Key",
  "workspace.keys.placeholder": "ป้อนชื่อ Key",
  "workspace.keys.empty": "สร้าง ClawC Gateway API key",
  ...
  "workspace.black.subscription.message": "คุณสมัครสมาชิก ClawC Black ในราคา ${{plan}} ต่อเดือน",
  ...
  "workspace.black.waitlist.joined": "คุณอยู่ในรายชื่อรอสำหรับแผน ClawC Black ราคา ${{plan}} ต่อเดือน",
  "workspace.black.waitlist.ready": "เราพร้อมที่จะลงทะเบียนให้คุณเข้าสู่แผน ClawC Black ราคา ${{plan}} ต่อเดือนแล้ว",
  ...
  "workspace.lite.subscription.message": "คุณได้สมัครสมาชิก ClawC Go แล้ว",
  ...
  "workspace.lite.subscription.selectProvider":
    'เลือก "ClawC Go" เป็นผู้ให้บริการในการตั้งค่า clawc ของคุณเพื่อใช้โมเดล Go',
  "workspace.lite.black.message":
    "ขณะนี้คุณสมัครสมาชิก ClawC Black หรืออยู่ในรายการรอ โปรดยกเลิกการสมัครก่อนหากต้องการเปลี่ยนไปใช้ Go",
  "workspace.lite.other.message":
    "สมาชิกคนอื่นใน Workspace นี้ได้สมัคร ClawC Go แล้ว สามารถสมัครได้เพียงหนึ่งคนต่อหนึ่ง Workspace เท่านั้น",
  "workspace.lite.promo.description":
    "ClawC Go เริ่มต้นที่ {{price}} จากนั้น $10/เดือน และมอบการเข้าถึงโมเดลการเขียนโค้ดแบบเปิดยอดนิยมอย่างเสถียรพร้อมขีดจำกัดการใช้งานที่ให้มาอย่างเหลือเฟือ",
  ...
  "download.title": "ClawC | ดาวน์โหลด",
  "download.meta.description": "ดาวน์โหลด ClawC สำหรับ macOS, Windows และ Linux",
  "download.hero.title": "ดาวน์โหลด ClawC",
  ...
  "download.section.extensions": "ส่วนขยาย ClawC",
  "download.section.integrations": "การเชื่อมต่อ ClawC",
  ...
  "download.faq.a3.beforeLocal":
    "ไม่จำเป็นเสมอไป แต่อาจจะต้องมี คุณจะต้องมีการสมัครสมาชิก AI หากต้องการเชื่อมต่อ ClawC กับผู้ให้บริการที่มีค่าใช้จ่าย แม้ว่าคุณจะสามารถทำงานกับ",
  "download.faq.a3.localLink": "โมเดล Local",
  "download.faq.a3.afterLocal.beforeZen": "ได้ฟรี แม้ว่าเราจะแนะนำให้ผู้ใช้ใช้งาน",
  "download.faq.a3.afterZen": ", ClawC ก็ทำงานร่วมกับผู้ให้บริการยอดนิยมทั้งหมด เช่น OpenAI, Anthropic, xAI เป็นต้น",

  "download.faq.a5.p1": "ClawC ใช้งานได้ฟรี 100%",
  "download.faq.a5.p2.beforeZen":
    "ค่าใช้จ่ายเพิ่มเติมใดๆ จะมาจากการสมัครสมาชิกของคุณกับผู้ให้บริการโมเดล แม้ว่า ClawC จะทำงานร่วมกับผู้ให้บริการโมเดลใดก็ได้ แต่เราแนะนำให้ใช้",
  "download.faq.a5.p2.afterZen": "",

  "download.faq.a6.p1": "ข้อมูลของคุณจะถูกจัดเก็บเฉพาะเมื่อคุณสร้างลิงก์ที่แชร์ได้ใน ClawC เท่านั้น",
  "download.faq.a6.p2.beforeShare": "เรียนรู้เพิ่มเติมเกี่ยวกับ",
  "download.faq.a6.shareLink": "หน้าแชร์",

  "enterprise.title": "ClawC | โซลูชันระดับองค์กรสำหรับองค์กรของคุณ",
  "enterprise.meta.description": "ติดต่อ ClawC สำหรับโซลูชันระดับองค์กร",
  "enterprise.hero.title": "โค้ดของคุณเป็นของคุณ",
  "enterprise.hero.body1":
    "ClawC ทำงานอย่างปลอดภัยภายในองค์กรของคุณ โดยไม่มีการจัดเก็บข้อมูลหรือบริบท และไม่มีข้อจำกัดด้านไลเซนส์หรือการอ้างสิทธิ์ความเป็นเจ้าของ เริ่มทดลองใช้งานกับทีมของคุณ แล้วนำไปใช้งานทั่วทั้งองค์กรโดยการผสานรวมกับ SSO และ AI gateway ภายในของคุณ",
  ...
  "enterprise.faq.q1": "ClawC Enterprise คืออะไร?",
  "enterprise.faq.a1":
    "ClawC Enterprise สำหรับองค์กรที่ต้องการให้มั่นใจว่าโค้ดและข้อมูลจะไม่ออกนอกโครงสร้างพื้นฐานของตน ทำได้โดยใช้การตั้งค่าแบบศูนย์กลางที่ผสานรวมกับ SSO และ AI gateway ภายในของคุณ",
  "enterprise.faq.q2": "จะเริ่มต้นกับ ClawC Enterprise ได้อย่างไร?",
  "enterprise.faq.a2":
    "เพียงเริ่มจากการทดลองใช้งานภายในกับทีมของคุณ โดยค่าเริ่มต้น ClawC ไม่จัดเก็บโค้ดหรือข้อมูลบริบทของคุณ ทำให้เริ่มต้นได้ง่าย จากนั้นติดต่อเราเพื่อพูดคุยเรื่องราคาและตัวเลือกการติดตั้งใช้งาน",
  ...
  "enterprise.faq.q4": "ข้อมูลของฉันปลอดภัยกับ ClawC Enterprise หรือไม่?",
  "enterprise.faq.a4":
    "ใช่ ClawC ไม่จัดเก็บโค้ดหรือข้อมูลบริบทของคุณ การประมวลผลทั้งหมดเกิดขึ้นในเครื่องหรือผ่านการเรียก API โดยตรงไปยังผู้ให้บริการ AI ของคุณ ด้วยการตั้งค่าแบบศูนย์กลางและการผสานรวม SSO ข้อมูลของคุณจะยังคงปลอดภัยอยู่ภายในโครงสร้างพื้นฐานขององค์กร",

  "brand.title": "ClawC | แบรนด์",
  "brand.meta.description": "แนวทางการใช้แบรนด์ ClawC",
  "brand.heading": "แนวทางการใช้แบรนด์",
  "brand.subtitle": "ทรัพยากรและแอสเซทเพื่อช่วยให้คุณใช้งานแบรนด์ ClawC",
  "brand.downloadAll": "ดาวน์โหลดแอสเซททั้งหมด",

  "changelog.title": "ClawC | บันทึกการเปลี่ยนแปลง",
  "changelog.meta.description": "บันทึกการออกรุ่นและบันทึกการเปลี่ยนแปลง ClawC",
  "changelog.hero.title": "บันทึกการเปลี่ยนแปลง",
  "changelog.hero.subtitle": "การอัปเดตและการปรับปรุงใหม่ใน ClawC",
