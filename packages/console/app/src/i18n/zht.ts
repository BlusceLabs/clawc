...
export const dict = {
  ...
  "notFound.title": "找不到頁面 | ClawC",
  "notFound.heading": "404 - 找不到頁面",
  "notFound.home": "首頁",
  "notFound.docs": "文件",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "clawc 淺色標誌",
  "notFound.logoDarkAlt": "clawc 深色標誌",
  ...
  "app.meta.description": "ClawC - 開源編碼代理。",

  "home.title": "ClawC | 開源 AI 編碼代理",

  "temp.title": "ClawC | 專為終端打造的 AI 編碼代理",
  ...
  "temp.feature.zen.afterLink": "由 ClawC 提供",
  "temp.feature.models.beforeLink": "透過",
  "temp.feature.models.afterLink": "支援 75+ 家 LLM 供應商，包括本地模型",
  "temp.screenshot.caption": "使用 tokyonight 主題的 ClawC TUI",
  "temp.screenshot.alt": "使用 tokyonight 主題的 ClawC TUI",
  "temp.logoLightAlt": "clawc 淺色標誌",
  "temp.logoDarkAlt": "clawc 深色標誌",
  ...
  "home.what.title": "什麼是 ClawC？",
  "home.what.body": "ClawC 是一個開源代理，幫助你在終端、IDE 或桌面端編寫程式碼。",
  ...
  "home.growth.body":
    "擁有超過 <strong>{{stars}}</strong> 個 GitHub Star、<strong>{{contributors}}</strong> 位貢獻者以及超過 <strong>{{commits}}</strong> 次提交，ClawC 每月被超過 <strong>{{monthlyUsers}}</strong> 名開發者使用並信賴。",
  "home.growth.githubStars": "GitHub Star",
  "home.growth.contributors": "貢獻者",
  "home.growth.monthlyDevs": "每月活躍開發者",

  "home.privacy.title": "隱私優先",
  "home.privacy.body": "ClawC 不儲存你的程式碼或上下文資料，因此可以在注重隱私的環境中運作。",
  "home.privacy.learnMore": "了解更多關於",
  "home.privacy.link": "隱私",

  "home.faq.q1": "什麼是 ClawC？",
  "home.faq.a1":
    "ClawC 是一個開源代理，幫助你使用任意 AI 模型編寫並執行程式碼。它提供終端介面、桌面應用程式或 IDE 擴充功能。",
  "home.faq.q2": "如何使用 ClawC？",
  "home.faq.a2.before": "最簡單的方式是先閱讀",
  "home.faq.a2.link": "入門介紹",
  "home.faq.q3": "使用 ClawC 需要額外的 AI 訂閱嗎？",
  "home.faq.a3.p1": "不一定。ClawC 自帶一組免費模型，無需建立帳號即可使用。",
  "home.faq.a3.p2.beforeZen": "此外，你可以透過建立",
  "home.faq.a3.p2.afterZen": "帳號使用常見的編碼模型。",
  "home.faq.a3.p3": "我們鼓勵使用 Zen，但 ClawC 也支援 OpenAI、Anthropic、xAI 等主流供應商。",
  "home.faq.a3.p4.beforeLocal": "你還可以連接你的",
  "home.faq.a3.p4.localLink": "本地模型",
  "home.faq.q4": "可以使用我現有的 AI 訂閱嗎？",
  "home.faq.a4.p1":
    "可以。ClawC 支援主流供應商的訂閱方案，包括 Claude Pro/Max、ChatGPT Plus/Pro 與 GitHub Copilot。",
  "home.faq.q5": "ClawC 只能在終端中使用嗎？",
  "home.faq.a5.beforeDesktop": "不再是了！ClawC 現在也提供",
  "home.faq.a5.desktop": "桌面端",
  "home.faq.a5.and": "與",
  "home.faq.a5.web": "網頁端",
  "home.faq.q6": "ClawC 價格如何？",
  "home.faq.a6": "ClawC 100% 免費使用。它也自帶一組免費模型。如果你連接其他供應商，可能會產生額外費用。",
  ...
  "home.faq.q8": "ClawC 是開源的嗎？",
  "home.faq.a8.p1": "是的，ClawC 完全開源。原始碼公開在",
  "home.faq.a8.p2": "並採用",
  ...
  "home.zenCta.body":
    "Zen 提供一組精選的 AI 模型，這些模型是 ClawC 為了編碼代理專門測試與評測過的。無需擔心不同供應商之間效能與品質參差不齊，使用經過驗證的模型即可。",
  "home.zenCta.link": "了解 Zen",

  "zen.title": "ClawC Zen | 專為編碼代理精選的可靠最佳化模型",
  "zen.hero.title": "專為編碼代理提供的可靠最佳化模型",
  "zen.hero.body":
    "Zen 提供一組精選的 AI 模型，這些模型是 ClawC 為了編碼代理專門測試與評測過的。無需擔心效能與品質參差不齊，使用經過驗證的模型即可。",

  "zen.faq.q1": "什麼是 ClawC Zen？",
  "zen.faq.a1": "Zen 是由 ClawC 團隊打造、專為編碼代理測試與評測的 AI 模型精選集合。",
  "zen.faq.q2": "是什麼讓 Zen 更準確？",
  "zen.faq.a2": "Zen 只提供專為編碼代理測試與評測的模型。你不會用奶油刀切牛排，也別用糟糕的模型來寫程式。",
  "zen.faq.q3": "Zen 更便宜嗎？",
  "zen.faq.a3":
    "Zen 不以營利為目的。Zen 會把模型供應商的成本原樣轉給你。Zen 的使用量越高，ClawC 就越能談到更好的價格並把優惠讓利給你。",
  ...
  "zen.faq.a4.p3": "為了覆蓋成本，ClawC 只會收取很小的支付處理費：每次儲值 $20 會額外收取 $1.23。",
  "zen.faq.q5": "資料與隱私如何？",
  ...
  "zen.faq.a8":
    "Zen 與 ClawC 搭配得很好，但你也可以在任何代理中使用 Zen。請在你偏好的編碼代理中按照設定說明進行配置。",
  ...
  "zen.problem.subtitle": "我們正在為所有人解決此問題，而不僅僅是 ClawC 使用者。",
  ...
  "zen.how.body": "雖然我們建議你將 Zen 與 ClawC 一起使用，但你可以將 Zen 與任何代理一起使用。",
  ...
  "go.problem.body":
    "我們致力於將 ClawC 體驗帶給盡可能多的人。ClawC Go 是一款低成本訂閱服務：首月 $5，之後 $10/月。它提供充裕的額度，並讓您能可靠地使用最強大的開源模型。",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go 起價為首月 $5，之後 $10/月。您可以將其與 ClawC 或任何代理搭配使用。",
  ...
  "zen.api.error.trialEnded": "{{model}} 的限免活动已結束。您可以訂閱 ClawC Go 繼續使用該模型 - {{link}}",

  "black.meta.title": "ClawC Black | 存取全球最佳編碼模型",
  "black.meta.description": "透過 ClawC Black 訂閱方案存取 Claude、GPT、Gemini 等模型。",
  "black.hero.title": "存取全球最佳編碼模型",
  "black.hero.subtitle": "包括 Claude、GPT、Gemini 等",
  "black.title": "ClawC Black | 定價",
  ...
  "black.workspace.title": "ClawC Black | 選擇工作區",
  "black.workspace.selectPlan": "為此方案選擇一個工作區",
  "black.workspace.name": "工作區 {{n}}",
  "black.subscribe.title": "訂閱 ClawC Black",
  ...
  "black.subscribe.success.title": "你已在 ClawC Black 候補名單上",
  ...
  "workspace.newUser.feature.lockin.body":
    "將 Zen 與任何編碼代理結合使用，並在需要時隨時使用 ClawC 連接其他供應商。",
  ...
  "workspace.newUser.step.login.after": "並選擇 ClawC",
  "workspace.newUser.step.pasteKey": "貼上你的 API 金鑰",
  "workspace.newUser.step.models.before": "啟動 ClawC 並執行",
  ...
  "workspace.keys.subtitle": "管理你的 API 金鑰以存取 ClawC 服務。",
  "workspace.keys.create": "建立 API 金鑰",
  "workspace.keys.placeholder": "輸入金鑰名稱",
  "workspace.keys.empty": "建立 ClawC 閘道器 API 金鑰",
  ...
  "workspace.black.subscription.message": "你已訂閱 ClawC Black，費用為每月 ${{plan}}。",
  ...
  "workspace.black.waitlist.joined": "你已加入每月 ${{plan}} 的 ClawC Black 方案候補名單。",
  "workspace.black.waitlist.ready": "我們已準備好將你加入每月 ${{plan}} 的 ClawC Black 方案。",
  ...
  "workspace.lite.subscription.message": "您已訂閱 ClawC Go。",
  ...
  "workspace.lite.subscription.selectProvider":
    "在您的 clawc 設定中選擇「ClawC Go」作為提供商，即可使用 Go 模型。",
  "workspace.lite.black.message": "您目前已訂閱 ClawC Black 或在候補名單中。若要切換至 Go，請先取消訂閱。",
  "workspace.lite.other.message": "此工作區中的另一位成員已訂閱 ClawC Go。每個工作區只能有一位成員訂閱。",
  "workspace.lite.promo.description":
    "ClawC Go 起價為 {{price}}，之後 $10/月，並提供對熱門開放編碼模型的可靠存取，同時享有充裕的使用額度。",
  ...
  "download.title": "ClawC | 下載",
  "download.meta.description": "下載適用於 macOS、Windows 與 Linux 的 ClawC",
  "download.hero.title": "下載 ClawC",
  "download.hero.subtitle": "適用於 macOS、Windows 與 Linux 的 Beta 版現已提供",
  "download.hero.button": "下載 {{os}} 版",
  "download.section.terminal": "ClawC 終端",
  "download.section.desktop": "ClawC 桌面版（Beta）",
  "download.section.extensions": "ClawC 擴充功能",
  "download.section.integrations": "ClawC 整合",
  ...
  "download.faq.a3.beforeLocal":
    "不一定，但很可能需要。如果你想將 ClawC 連接到付費供應商，你需要 AI 訂閱，不過你也可以使用",
  "download.faq.a3.localLink": "本地模型",
  "download.faq.a3.afterLocal.beforeZen": "免費。我們也推薦使用",
  "download.faq.a3.afterZen": "，但 ClawC 同樣支援 OpenAI、Anthropic、xAI 等所有主流供應商。",

  "download.faq.a5.p1": "ClawC 100% 免費使用。",
  "download.faq.a5.p2.beforeZen": "額外費用來自你對模型供應商的訂閱。雖然 ClawC 支援任何模型供應商，但我們建議使用",
  "download.faq.a5.p2.afterZen": "。",

  "download.faq.a6.p1": "你的資料與資訊只會在你於 ClawC 中建立可分享連結時被儲存。",
  "download.faq.a6.p2.beforeShare": "了解更多關於",
  "download.faq.a6.shareLink": "分享頁面",

  "enterprise.title": "ClawC | 面向組織的企業解決方案",
  "enterprise.meta.description": "聯絡 ClawC 取得企業解決方案",
  "enterprise.hero.title": "你的程式碼屬於你",
  "enterprise.hero.body1":
    "ClawC 在你的組織內部安全運作，不會儲存任何資料或上下文，也沒有授權限制或所有權主張。你可以先與團隊進行試用，然後透過與你的 SSO 與內部 AI 閘道器整合，將其部署到整個組織。",
  ...
  "enterprise.faq.q1": "什麼是 ClawC Enterprise？",
  "enterprise.faq.a1":
    "ClawC Enterprise 適用於希望確保程式碼與資料絕不離開自己基礎設施的組織。透過中央化設定，它可與你的 SSO 與內部 AI 閘道器整合，以達成此目標。",
  "enterprise.faq.q2": "如何開始使用 ClawC Enterprise？",
  "enterprise.faq.a2":
    "只要先以團隊的內部試用開始。ClawC 預設不會儲存你的程式碼或上下文資料，所以上手非常容易。之後聯絡我們，討論定價與完整實作方案。",
  "enterprise.faq.q3": "企業定價是如何進行的？",
  "enterprise.faq.a3":
    "我們提供按席位的企業定價。如果你有自己的 LLM 閘道器，我們不會對使用的 token 另外收費。更多詳情，請聯絡我們以獲得依據組織需求的客製報價。",
  "enterprise.faq.q4": "我的資料在 ClawC Enterprise 中是安全的嗎？",
  "enterprise.faq.a4":
    "是的。ClawC 不會儲存你的程式碼或上下文資料。所有處理都會在本地或透過直接呼叫你的 AI 供應商 API 完成。透過中央化設定與 SSO 整合，你的資料會安全保留在組織的基礎設施內部。",

  "brand.title": "ClawC | 品牌",
  "brand.meta.description": "ClawC 品牌指南",
  "brand.heading": "品牌指南",
  "brand.subtitle": "協助你使用 ClawC 品牌的資源與素材。",
  "brand.downloadAll": "下載所有素材",

  "changelog.title": "ClawC | 更新日誌",
  "changelog.meta.description": "ClawC 發布說明與更新日誌",
  "changelog.hero.title": "更新日誌",
  "changelog.hero.subtitle": "ClawC 的新更新與改善",
