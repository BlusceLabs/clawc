...
import { Database, eq, and, isNull } from "@clawc/console-core/drizzle/index.js"
import { BillingTable, LiteTable } from "@clawc/console-core/schema/billing.sql.js"
        ...
        {(sub) => (
          <section class={styles.root}>
            ...
            <div data-slot="beta-notice">
              ...
              <a href={language.route("/docs/providers/#clawc-go")} target="_blank" rel="noopener noreferrer">
