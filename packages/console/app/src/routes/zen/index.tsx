...
import compareVideo from "../../asset/lander/clawc-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/clawc-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="clawc:auth" content={loggedin() ? "true" : "false"} />
