...
import { Credential } from "@clawc/schema/credential"
import { Integration } from "@clawc/schema/integration"
...
export class Service extends Context.Service<Service, Interface>()("@clawc/v2/Credential") {}
