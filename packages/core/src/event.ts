...
import { Event } from "@clawc/schema/event"
import type { Data, Definition, Payload } from "@clawc/schema/event"
...
import { Durable } from "@clawc/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@clawc/schema/event").ID
export type { Data, Definition, Payload } from "@clawc/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@clawc/Event") {}
