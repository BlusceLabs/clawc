...
export class Service extends Context.Service<Service, Interface>()("@clawc/v2/FileSystem/Search") {}
...
export const locationLayer = Layer.unwrap(
  Effect.sync(() => (Flag.CLAWC_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)),
)
