...
import { FileSystemWatcher } from "@clawc/schema/filesystem-watcher"
...
declare const CLAWC_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof CLAWC_LIBC === "undefined" ? undefined : CLAWC_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@clawc/v2/FileWatcher") {}

export const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.CLAWC_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (yield* Flag.CLAWC_EXPERIMENTAL_FILEWATCHER) {
