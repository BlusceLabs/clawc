...
import { Event } from "@clawc/schema/project-directories"
import { ProjectCopy } from "@clawc/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@clawc/ProjectCopy") {}
