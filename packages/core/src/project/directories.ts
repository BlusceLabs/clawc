...
import type { EffectDrizzleSqlite } from "@clawc/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@clawc/ProjectDirectories") {}
