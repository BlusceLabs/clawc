...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@clawc/llm"
...
export class Service extends Context.Service<Service, Interface>()("@clawc/v2/ToolRegistry") {}
