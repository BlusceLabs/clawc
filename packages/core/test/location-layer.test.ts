...
import { Tool } from "@clawc/core/tool/tool"
import { define } from "@clawc/plugin/v2/effect"
...
import { SessionRunnerModel } from "@clawc/core/session/runner/model"
      ...
      Effect.flatMap(([blocked, allowed]) =>
        Effect.gen(function* () {
          ...
          yield* Effect.promise(() =>
            fs.writeFile(
              path.join(blocked.path, "clawc.json"),
              JSON.stringify({
