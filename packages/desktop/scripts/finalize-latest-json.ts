...
const releaseId = process.env.CLAWC_RELEASE
if (!releaseId) throw new Error("CLAWC_RELEASE is required")

const version = process.env.CLAWC_VERSION
if (!version) throw new Error("CLAWC_VERSION is required")
...
const macxTarGz = "clawc-desktop-mac-x64.app.tar.gz"
const macaTarGz = "clawc-desktop-mac-arm64.app.tar.gz"
