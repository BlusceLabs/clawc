...
class Database extends Context.Service<Database, DatabaseShape>()("@clawc/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@clawc/example/UserStore") {
