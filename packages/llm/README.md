...
Schema-first LLM core for clawc. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@clawc/llm"
import { OpenAI } from "@clawc/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@clawc/llm/providers"
