...
const en = {
  "app.title": "AI Model Usage Rankings | ClawC Data",
  "app.description":
    "Explore ClawC Go usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  "app.unfurlAlt": "ClawC Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star ClawC on GitHub",
  "header.github": "GitHub",
  "header.tryClawC": "Try ClawC",
  ...
  "home.topModelsDescription": "Usage of models across ClawC Go.",
  ...
  "home.uniqueUsersDescription": "Daily unique ClawC Go users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | ClawC Data",
  "lab.description":
    "Compare {{lab}} models used in ClawC Go, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent ClawC usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in ClawC",
  ...
  "lab.shareOfUsage": "{{share}} of recent ClawC usage",
  "lab.usageTitle": "{{lab}} token usage",
  "lab.usageDescription": "Daily ClawC token volume over the last two months.",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | ClawC Data",
  "model.description":
    "View {{model}} ClawC Go usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. ClawC Go usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's ClawC Go usage",
  "model.ranked": "Ranked #{{rank}} across last week's ClawC Go usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No ClawC Go usage in the current data window.",
  ...
  "model.inputs": "Inputs",
  "model.overviewDescription": "Recent ClawC Go tokens, unique users, and market position.",
  "model.noSummaryTitle": "No usage summary",
  "model.noSummaryDescription": "This model has no ClawC Go usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Daily ClawC Go token volume over the recent two-month window.",
  ...
  "model.usersDescription": "Daily unique ClawC Go users over the recent two-month window.",
  ...
  "model.efficiencyDescription": "Cost, cache behavior, and average ClawC Go session shape.",
  ...
  "model.geoDescription": "ClawC Go model tokens used by country.",
  "model.noGeoTitle": "No geo data",
  "model.noGeoDescription": "No ClawC Go geo rows matched this model.",
  "model.worldMap": "World map of model token usage by country",
  "model.peersDescription": "Nearby models by recent ClawC Go token volume.",
