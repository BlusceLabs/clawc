export const dict = {
  "app.title": "Ranking de uso de modelos de IA | ClawC Data",
  "app.description":
    "Explore o uso do ClawC Go em modelos de IA, incluindo volume de tokens, rankings, participação de mercado, preço por token, custo por sessão, taxa de cache e distribuição geográfica.",
  "app.unfurlAlt": "Logotipo do ClawC Data sobre um fundo escuro padronizado",
  ...
  "header.githubAria": "Dar estrela ao ClawC no GitHub",
  "header.github": "GitHub",
  "header.tryClawC": "Experimente o ClawC",
  ...
  "footer.homeAria": "Início do ClawC",
  ...
  "modal.title": "Newsletter do ClawC",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos no ClawC Go.",
  ...
  "home.uniqueUsersDescription": "Usuários únicos diários do ClawC Go por modelo.",
  ...
  "lab.title": "Uso e ranking de modelos de IA da {{lab}} | ClawC Data",
  "lab.description":
    "Compare modelos da {{lab}} usados no ClawC Go, incluindo uso de tokens, ranking de modelos, janelas de contexto, datas de lançamento, custos e dados específicos de cada modelo.",
  "lab.loadingTitle": "Laboratório de modelos",
  "lab.loadingDescription": "Lendo disponibilidade de modelos e uso recente do ClawC.",
  "lab.notFound": "Nenhum modelo correspondeu a este laboratório.",
  "lab.heroPrefix": "Explore {{count}} modelos da {{lab}} usados no ClawC",
  ...
  "lab.shareOfUsage": "{{share}} do uso recente do ClawC",
  "lab.usageTitle": "Uso de tokens da {{lab}}",
  "lab.usageDescription": "Volume diário de tokens do ClawC nos últimos dois meses.",
  ...
  "model.title": "Uso, custo e posição de {{model}} | ClawC Data",
  "model.description":
    "Veja dados de uso de {{model}} no ClawC Go, incluindo volume de tokens, ranking semanal, combinação de tokens, custos, taxa de cache, sessões, distribuição geográfica e modelos pares.",
  ...
  "model.catalogFallback":
    "Fatos do modelo do índice compartilhado de modelos. O uso no ClawC Go aparece quando este modelo tiver atividade.",
  "model.unranked": "Sem classificação no uso do ClawC Go da última semana",
  "model.ranked": "Classificado em #{{rank}} no uso do ClawC Go da última semana",
  ...
  "model.noCurrentUsage": "Sem uso do ClawC Go na janela de dados atual.",
  ...
  "model.overviewDescription": "Tokens recentes do ClawC Go, usuários únicos e posição de mercado.",
  "model.noSummaryTitle": "Sem resumo de uso",
  "model.noSummaryDescription": "Este modelo ainda não tem linhas de uso do ClawC Go.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volume diário de tokens do ClawC Go na janela recente de dois meses.",
  ...
  "model.usersDescription": "Usuários únicos diários do ClawC Go na janela recente de dois meses.",
  ...
  "model.efficiencyDescription": "Custo, comportamento de cache e formato médio da sessão do ClawC Go.",
  ...
  "model.geoDescription": "Tokens do modelo ClawC Go usados por país.",
  "model.noGeoTitle": "Sem dados geográficos",
  "model.noGeoDescription": "Nenhuma linha geográfica do ClawC Go correspondeu a este modelo.",
  "model.worldMap": "Mapa-múndi do uso de tokens do modelo por país",
  "model.peersDescription": "Modelos próximos por volume recente de tokens do ClawC Go.",
