export const dict = {
  "app.title": "Clasificaciones de uso de modelos de IA | ClawC Data",
  "app.description":
    "Explora el uso de ClawC Go en modelos de IA, incluido el volumen de tokens, clasificaciones, cuota de mercado, precios de tokens, coste por sesión, ratio de caché y desgloses geográficos.",
  "app.unfurlAlt": "Logotipo textual de ClawC Data sobre un fondo oscuro con patrón",
  ...
  "header.githubAria": "Dale una estrella a ClawC en GitHub",
  "header.github": "GitHub",
  "header.tryClawC": "Probar ClawC",
  ...
  "footer.homeAria": "Inicio de ClawC",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos en ClawC Go.",
  ...
  "home.uniqueUsersDescription": "Usuarios únicos diarios de ClawC Go por modelo.",
  ...
  "lab.title": "Uso y clasificaciones de modelos de IA de {{lab}} | ClawC Data",
  "lab.description":
    "Compara modelos de {{lab}} usados en ClawC Go, incluido uso de tokens, clasificaciones de modelos, ventanas de contexto, fechas de lanzamiento, costes y datos específicos del modelo.",
  "lab.loadingTitle": "Laboratorio de modelos",
  "lab.loadingDescription": "Leyendo disponibilidad de modelos y uso reciente de ClawC.",
  "lab.notFound": "Ningún modelo coincidió con este laboratorio.",
  "lab.heroPrefix": "Explora {{count}} modelos de {{lab}} usados en ClawC",
  ...
  "lab.shareOfUsage": "{{share}} del uso reciente de ClawC",
  "lab.usageTitle": "Uso de tokens de {{lab}}",
  "lab.usageDescription": "Volumen diario de tokens de ClawC durante los últimos dos meses.",
  ...
  "lab.usage": "Uso",
  "lab.share": "Cuota",
  "model.title": "Uso, coste y posición de {{model}} | ClawC Data",
  "model.description":
    "Consulta datos de uso de {{model}} en ClawC Go, incluido volumen de tokens, posición semanal, mezcla de tokens, costes, ratio de caché, sesiones, desgloses geográficos y modelos similares.",
  ...
  "model.catalogFallback":
    "Datos del modelo desde el índice compartido de modelos. El uso de ClawC Go aparecerá cuando este modelo tenga actividad.",
  "model.unranked": "Sin clasificación en el uso de ClawC Go de la semana pasada",
  "model.ranked": "Clasificado #{{rank}} en el uso de ClawC Go de la semana pasada",
  ...
  "model.noCurrentUsage": "Sin uso de ClawC Go en la ventana de datos actual.",
  ...
  "model.overviewDescription": "Tokens recientes de ClawC Go, usuarios únicos y posición de mercado.",
  "model.noSummaryTitle": "Sin resumen de uso",
  "model.noSummaryDescription": "Este modelo aún no tiene filas de uso de ClawC Go.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volumen diario de tokens de ClawC Go durante la ventana reciente de dos meses.",
  ...
  "model.usersDescription": "Usuarios únicos diarios de ClawC Go durante la ventana reciente de dos meses.",
  ...
  "model.efficiencyDescription": "Coste, comportamiento de caché y forma media de sesión de ClawC Go.",
  ...
  "model.geoDescription": "Tokens del modelo de ClawC Go usados por país.",
  "model.noGeoTitle": "Sin datos geográficos",
  "model.noGeoDescription": "Ninguna fila geográfica de ClawC Go coincidió con este modelo.",
  "model.worldMap": "Mapa mundial del uso de tokens del modelo por país",
  "model.peersDescription": "Modelos cercanos por volumen reciente de tokens de ClawC Go.",
