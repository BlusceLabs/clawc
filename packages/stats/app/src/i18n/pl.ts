export const dict = {
  "app.title": "Rankingi użycia modeli AI | ClawC Data",
  "app.description":
    "Przeglądaj użycie ClawC Go w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny ClawC Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę ClawC na GitHub",
  "header.github": "GitHub",
  "header.tryClawC": "Wypróbuj ClawC",
  ...
  "footer.homeAria": "Strona główna ClawC",
  ...
  "home.topModelsDescription": "Użycie modeli w ClawC Go.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy ClawC Go według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | ClawC Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w ClawC Go, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia ClawC.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w ClawC",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia ClawC",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów ClawC z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | ClawC Data",
  "model.description":
    "Zobacz dane użycia {{model}} w ClawC Go, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie ClawC Go pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu ClawC Go z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu ClawC Go z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia ClawC Go w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny ClawC Go, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia ClawC Go.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów ClawC Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy ClawC Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji ClawC Go.",
  ...
  "model.geoDescription": "Tokeny modelu ClawC Go użyte według kraju.",
  "model.noGeoTitle": "Brak danych geograficznych",
  "model.noGeoDescription": "Żadne wiersze geograficzne ClawC Go nie pasowały do tego modelu.",
  "model.worldMap": "Mapa świata użycia tokenów modelu według kraju",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów ClawC Go.",
