export const dict = {
  "app.title": "Yapay Zeka Model Kullanım Sıralamaları | ClawC Data",
  "app.description":
    "ClawC Go kullanımını yapay zeka modelleri genelinde keşfedin: token hacmi, sıralamalar, pazar payı, token fiyatlandırması, oturum maliyeti, önbellek oranı ve coğrafi dağılımlar.",
  "app.unfurlAlt": "Koyu desenli arka plan üzerinde ClawC Data logosu",
  ...
  "header.githubAria": "GitHub'da ClawC'a yıldız ver",
  "header.github": "GitHub",
  "header.tryClawC": "ClawC'u dene",
  ...
  "footer.homeAria": "ClawC ana sayfası",
  ...
  "home.topModelsDescription": "ClawC Go genelinde model kullanımı.",
  ...
  "home.uniqueUsersDescription": "Modele göre günlük benzersiz ClawC Go kullanıcıları.",
  ...
  "lab.title": "{{lab}} Yapay Zeka Model Kullanımı ve Sıralamaları | ClawC Data",
  "lab.description":
    "ClawC Go'da kullanılan {{lab}} modellerini karşılaştırın: token kullanımı, model sıralamaları, bağlam pencereleri, yayın tarihleri, maliyetler ve modele özel veriler.",
  "lab.loadingTitle": "Model Laboratuvarı",
  "lab.loadingDescription": "Model kullanılabilirliği ve son ClawC kullanımı okunuyor.",
  "lab.notFound": "Bu laboratuvarla eşleşen model yok.",
  "lab.heroPrefix": "ClawC'da kullanılan {{count}} {{lab}} modelini keşfedin",
  ...
  "lab.shareOfUsage": "Son ClawC kullanımının {{share}} kadarı",
  "lab.usageTitle": "{{lab}} token kullanımı",
  "lab.usageDescription": "Son iki ayda günlük ClawC token hacmi.",
  ...
  "lab.usage": "Kullanım",
  "lab.share": "Pay",
  "model.title": "{{model}} Kullanımı, Maliyeti ve Sırası | ClawC Data",
  "model.description":
    "{{model}} için ClawC Go kullanım verilerini görüntüleyin: token hacmi, haftalık sıra, token karışımı, maliyetler, önbellek oranı, oturumlar, coğrafi dağılımlar ve benzer modeller.",
  ...
  "model.catalogFallback":
    "Paylaşılan model dizininden model bilgileri. Bu modelde etkinlik olduğunda ClawC Go kullanımı görünür.",
  "model.unranked": "Geçen haftaki ClawC Go kullanımında sıralanmamış",
  "model.ranked": "Geçen haftaki ClawC Go kullanımında #{{rank}} sırada",
  ...
  "model.noCurrentUsage": "Geçerli veri penceresinde ClawC Go kullanımı yok.",
  ...
  "model.overviewDescription": "Son ClawC Go tokenları, benzersiz kullanıcılar ve pazar konumu.",
  "model.noSummaryTitle": "Kullanım özeti yok",
  "model.noSummaryDescription": "Bu modelde henüz ClawC Go kullanım satırı yok.",
  ...
  "model.usageDescription": "Son iki aylık pencerede günlük ClawC Go token hacmi.",
  ...
  "model.usersDescription": "Son iki aylık pencerede günlük benzersiz ClawC Go kullanıcıları.",
  ...
  "model.efficiencyDescription": "Maliyet, önbellek davranışı ve ortalama ClawC Go oturum yapısı.",
  ...
  "model.geoDescription": "Ülkeye göre kullanılan ClawC Go model tokenları.",
  "model.noGeoTitle": "Coğrafi veri yok",
  "model.noGeoDescription": "Bu modelle eşleşen ClawC Go coğrafi satırı yok.",
  "model.worldMap": "Ülkeye göre model token kullanımının dünya haritası",
  "model.peersDescription": "Son ClawC Go token hacmine göre yakındaki modeller.",
