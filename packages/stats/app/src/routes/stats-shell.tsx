import clawcWordmarkDark from "../asset/logo-ornate-dark.svg"
...
export const githubLink = {
  ...
  apiHref: "https://api.github.com/repos/BlusceLabs/clawc",
  fallbackStars: "150K",
}
export const themePreferences = ["dark", "light", "system"] as const
export const themeStorageKey = "clawc:stats-theme"
    ...
    <header data-component="top" data-menu-open={menuOpen() ? "true" : undefined}>
      <div data-slot="header-bar">
        ...
        <div data-slot="header-actions">
          ...
          <a data-slot="header-button" data-variant="contrast" href="https://clawc.ai/">
            <strong>{i18n.t("header.tryClawC")}</strong>
          </a>
          <button
...
function ClawCMark() {
  return (
    <svg data-slot="clawc-mark" width="40" height="40" viewBox="0 0 40 40" fill="none" aria-hidden="true">
...
export function Footer(props: {
  ...
  const legal = [
    { href: "https://clawc.ai/legal/terms-of-service", label: i18n.t("footer.terms") },
    { href: "https://clawc.ai/legal/privacy-policy", label: i18n.t("footer.privacy") },
  ]
  const connect = [
    { href: "mailto:hello@clawc.ai", label: i18n.t("footer.contact") },
    { href: "https://clawc.ai/discord", label: i18n.t("footer.community") },
    { href: "https://x.com/clawc", label: "X" },
  ...
  return (
    <footer data-component="footer">
      ...
      <div data-slot="footer-grid">
        <a data-slot="footer-mark" href="https://clawc.ai" aria-label={i18n.t("footer.homeAria")}>
          <ClawCMark />
        </a>
    ...
    <div data-component="subscribe-modal" role="dialog" aria-modal="true" aria-labelledby="subscribe-title">
      ...
      <div data-slot="modal-panel">
        <div data-slot="modal-brand">
          <img data-slot="modal-logo" src={clawcWordmarkDark} alt="ClawC" />
          <button
