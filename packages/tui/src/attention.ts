...
import defaultSoundPath from "@clawc/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@clawc/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@clawc/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@clawc/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@clawc/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@clawc/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "clawc"
const DEFAULT_PACK_ID = "clawc.default"
