...
import { Portal, useRenderer, useTerminalDimensions, type JSX } from "@clawctui/solid"
import type { TextareaRenderable } from "@clawctui/core"
import { useTheme, selectedForeground } from "../../context/theme"
import type { PermissionRequest } from "@clawc/sdk/v2"
...
import { CLAWC_BASE_MODE, useBindings, useCommandShortcut } from "../../keymap"
          ...
          body={
            <Switch>
              <Match when={props.request.always.length === 1 && props.request.always[0] === "*"}>
                <TextBody title={"This will allow " + props.request.permission + " until ClawC is restarted."} />
              </Match>
              <Match when={true}>
                <box paddingLeft={1} gap={1}>
                  <text fg={theme.textMuted}>This will allow the following patterns until ClawC is restarted</text>
                  <box>
  ...
  return (
    ...
    >
      <box gap={1} paddingLeft={1} paddingRight={3} paddingTop={1} paddingBottom={1}>
        ...
        <box paddingLeft={1}>
          <text fg={theme.textMuted}>Tell ClawC what to do differently</text>
        </box>
      </box>
      <box
