...
const tools: readonly ToolFixture[] = [
  ...
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/clawc (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/clawc/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/clawc/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const CLAWC_DB|CLAWC_DB|CLAWC_DEV|Global\\.Path\\.data|data =" in packages/clawc/src (115 matches)',
  },
] as const
