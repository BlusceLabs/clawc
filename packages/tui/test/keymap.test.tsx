...
import { getOpencodeModeStack, CLAWC_BASE_MODE, OpencodeKeymapProvider, registerOpencodeKeymap } from "../src/keymap"
...
test("mode-less bindings stay active when clawc mode changes", async () => {
