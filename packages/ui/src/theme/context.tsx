...
const STORAGE_KEYS = {
  THEME_ID: "clawc-theme-id",
  COLOR_SCHEME: "clawc-color-scheme",
  THEME_CSS_LIGHT: "clawc-theme-css-light",
  THEME_CSS_DARK: "clawc-theme-css-dark",
} as const
...
export const { use: useTheme, provider: ThemeProvider } = createSimpleContext({
  ...
  init: (props: { defaultTheme?: string; onThemeApplied?: (theme: DesktopTheme, mode: "light" | "dark") => void }) => {
    const themeId = normalize(read(STORAGE_KEYS.THEME_ID) ?? props.defaultTheme) ?? "varth"
    ...
    onMount(() => {
      ...
      const savedTheme = normalize(rawTheme ?? props.defaultTheme) ?? "varth"
