...
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | @clawc/sdk aracılığıyla OpenCode kullanmak için Vercel AI SDK sağlayıcısı |
