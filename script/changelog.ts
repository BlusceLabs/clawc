...
Generates UPCOMING_CHANGELOG.md by running the clawc changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for clawc run (default: low)
      --quiet            Suppress clawc command output unless it fails
