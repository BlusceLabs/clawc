...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/BlusceLabs/clawc/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for BlusceLabs/clawc...\n")
...
console.log("Fetching npm all-time downloads for varth-ai...\n")
const npmDownloads = await fetchNpmDownloads("varth-ai")
